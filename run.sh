...
tmux send-keys -t examplesess:worker-0 'CUDA_VISIBLE_DEVICES= python example.py --job_name worker --task_index 0' Enter
tmux send-keys -t examplesess:worker-1 'CUDA_VISIBLE_DEVICES= python example.py --job_name worker --task_index 1' Enter
sleep 1
tmux a
